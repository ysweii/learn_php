...
<ul>
    ...
    <li class="user_main_input">
        <input class="TxtValidateCodeCssClass" id="captcha" name="captcha" type="text"><img src="/wshop/shop/index.php/Admin/Manager/verifyImg" onclick="this.src='/wshop/shop/index.php/Admin/Manager/verifyImg/'+Math.random()" /></li>
</ul>
                                </div>
                            </li>

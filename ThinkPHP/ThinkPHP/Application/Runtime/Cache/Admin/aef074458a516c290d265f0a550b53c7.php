...
<div class="div_head">
            <span>
                ...
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="/ThinkPHP/ThinkPHP/index.php/Admin/Authority/addAuth">【添加权限】</a>
                </span>
            </span>
</div>
<div></div>
<div style="font-size: 13px; margin: 10px 5px;">
    <table class="table_a" border="1" width="100%">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="product1">
                ...
                <td><a href="/ThinkPHP/ThinkPHP/index.php/Admin/Authority/updateAuth/auth_id/<?php echo ($vo['auth_id']); ?>">修改</a></td>
